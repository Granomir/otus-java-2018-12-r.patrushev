...
public class AutoLoggingWithProxy {
    ...
    public static void main(String[] args) {
        MyInterface myInterfaceObject1 = MyProxifier.getProxifiedObject(new MyInterfaceImpl1());
        myInterfaceObject1.methodA("1.1");
        System.out.println("-------------------------------");
        myInterfaceObject1.methodB("1.2");
        System.out.println("-------------------------------");
        MyInterface myInterfaceObject2 = MyProxifier.getProxifiedObject(new MyInterfaceImpl2());
